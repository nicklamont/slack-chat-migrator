...
from slack_chat_migrator import __main__
...
class TestMainModule:
    ...
    def test_main_function_is_imported_from_cli(self):
        """Verify main is imported from slack_chat_migrator.cli.commands."""
        from slack_chat_migrator.cli.commands import main

        assert __main__.main is main

    @patch("slack_chat_migrator.cli.commands.main")
    def test_runpy_invokes_main(self, mock_main):
        ...
        runpy.run_module("slack_chat_migrator", run_name="__main__", alter_sys=False)
        mock_main.assert_called_once()

    @patch("slack_chat_migrator.__main__.main")
    def test_main_not_called_on_import(self, mock_main):
        ...
        # is 'slack_chat_migrator.__main__', not '__main__'.
        mock_main.assert_not_called()

    @patch("slack_chat_migrator.cli.commands.cli")
