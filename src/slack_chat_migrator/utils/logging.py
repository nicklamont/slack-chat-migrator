...
def get_logger() -> logging.Logger:
    """Get the slack_chat_migrator logger, creating it with defaults if needed.

    Returns:
        The ``slack_chat_migrator`` logger instance.
    """
    slack_logger = logging.getLogger("slack_chat_migrator")
