...
class MessageAttachmentProcessor:
    ...
    def process_message_attachments(
        ...
        for file_obj in files:
            try:
                ...
                upload_result = self.file_handler.upload_attachment(file_obj, channel, space, user_service, sender_email)
    ...
    def _create_attachment_from_result(self, upload_result: Dict[str, Any]) -> Optional[Dict[str, Union[str, Dict[str, str]]]]:
